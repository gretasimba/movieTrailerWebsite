...
Last it calls fresh_tomatoes.open_movies_page, which creates HTML page that displays movies with title, and poster images. Movie trailer from YouTube shows whem poster omage is clicked.
...
lebowski = media.Movie("The Big Lebowski",
                       "Jeff Bridges plays Jeff Lebowski who insists on being called ""the Dude,"" a laid-back, easygoing burnout"
                       "who happens to have the same name as a millionaire whose wife owes a lot of dangerous people a whole bunch"
                       "of money -- resulting in the Dude having his rug soiled, sending him spiraling into the Los Angeles underworld.",
...
incredibles = media.Movie("The Icredibles",
                          "In this lauded Pixar animated film, married superheroes Mr. Incredible (Craig T. Nelson) and Elastigirl (Holly Hunter)"
                          "are forced to assume mundane lives as Bob and Helen Parr after all super-powered activities have been banned by the government."
                          "While Mr. Incredible loves his wife and kids, he longs to return to a life of adventure, and he gets a chance when summoned to"
                          "an island to battle an out-of-control robot. Soon, Mr. Incredible is in trouble, and it's up to his family to save him",
...
apocalypse = media.Movie("Apocalypse Now",
                         "In Vietnam in 1970, Captain Willard (Martin Sheen) takes a perilous and increasingly hallucinatory journey upriver to find"
                         "and terminate Colonel Kurtz (Marlon Brando), a once-promising officer who has reportedly gone completely mad."
                         "In the company of a Navy patrol boat filled with street-smart kids",
...
fight_club = media.Movie("Fight Club",
                         ...
                         "(Brad Pitt) and soon finds himself living in his squalid house after his perfect apartment is destroyed...",
